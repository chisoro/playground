/* Program.................cbrpt03.p
   Notes:................. Bank Transaction history Report
   Author:.................S. Mawire
*/
...
PROCEDURE report.ip:
    FOR EACH CBTrans WHERE CBTrans.bank = wsAcc AND CBTrans.Accper >= st-Per AND seq = 0:
    ...
    FOR EACH CBTrans WHERE CBTrans.bank = wsAcc AND CBTrans.Accper >= st-Per 
                      AND CBTrans.Accper <= end-Per AND seq <> 0:
        wsAmt = wsAmt + CBTrans.amount.
