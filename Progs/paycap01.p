...
/* Program.................paycap01.p
   Notes:...... Standard amount data capture - Single employee by item
   Author:.................S. Mawire
*/
...
DEF BROWSE brw-fac QUERY qry-fac
        DISPLAY Paymtf.Itemcode wsdesc Paymtf.StdAmt Paymtf.Active ENABLE Paymtf.ACTIVE WITH 16 DOWN SEPARATORS.
...
DO:
   ASSIGN Paymtf.StdAmt = DEC(wsAmt:SCREEN-VALUE).
    IF wsitem = Payctr.Basic THEN DO:
        DO X = 1 TO 3: /*Overtime items */
               IF Payctr.overtime[X] <> 0 THEN DO:
                   FIND FIRST paymtf WHERE paymtf.empcode = wsEmp AND paymtf.itemcode = Payctr.overtime[X] NO-ERROR.
                    ...
                    END.
                    Paymtf.StdAmt   = DEC(wsAmt:SCREEN-VALUE) / payemf.stdhours
                                        * Payctr.ORate[X]. 
               END.
        END.
    END.
...
DO: 
   ...
   ELSE DO:
       ...
       ELSE IF AVAILABLE paymtf THEN
            DISPLAY Paymtf.StdAmt @ wsAmt WITH FRAME frm-data.
