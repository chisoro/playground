...
/* Program.................paycos.p
    Notes:...... ..........Payroll re-Costing and consolidation
    Author:.................S. Mawire
*/
DEF STREAM a.
...
DEF BROWSE brwView QUERY qryView
 ...
 DEFINE FRAME frm-Paysys
     ...
     st-per    COLON 26 LABEL "Payroll Period" VIEW-AS TEXT SKIP(0.5)
     wsStatus  COLON 26 LABEL "Processing...." VIEW-AS TEXT SKIP(1.5)
     ...
     WITH 1 DOWN OVERLAY SIDE-LABELS CENTERED THREE-D 
      SIZE 95 BY 9
     TITLE "PAYROLL COSTING AND LEDGER CONSOLIDATION " VIEW-AS DIALOG-BOX.
...
FOR EACH payemf WHERE payemf.paysys = wsSys NO-LOCK:
    ...
    FOR EACH paymtf WHERE paymtf.empcode = payemf.empcode NO-LOCK:
        IF paymtf.CurAmt = 0 THEN NEXT.
        ELSE DO:
            FIND FIRST payitem WHERE payitem.itemcode = paymtf.itemcode NO-LOCK NO-ERROR.
            IF Payitem.cat = 1 OR Payitem.cat = 3 THEN /*Income and Acrual costing */
