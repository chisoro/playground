/* Program.................asrpt02.p
    Notes:...... ..........Asset Depreciation Report
    Author:.................S. Mawire
*/
...
DEFINE FRAME frm-Main
     SKIP(.5)
     st-date      COLON 31 LABEL "Start Depreciation Date" SKIP(0.3)
     end-date      COLON 31 LABEL "End Depreciation Date"
     ...
     WITH 1 DOWN OVERLAY SIDE-LABELS CENTERED THREE-D 
      SIZE 95 BY 15
     TITLE "ASSET DEPRECIATION REPORT" VIEW-AS DIALOG-BOX.
...
PROCEDURE Report.ip:
    ASSIGN wsTitle1 =  "ASSET DEPRECIATION REPORT BY CATEGORY BY SUB-CATEGORY FOR THE PERIOD "
    ...
    FOR EACH assmf WHERE assmf.cat >= st-cat AND assmf.cat <= en-cat
                    ...
                    AND assmf.DepDate >= st-date AND assmf.DepDate <= end-date  NO-LOCK
