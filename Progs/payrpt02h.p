...
/* Program.................payrpt02h.p
    Notes:...... ..........Payment listing Report form history
    Author:.................S. Mawire
*/
DEF STREAM a.
...
DEFINE RECTANGLE rect-2
 ...
 FORM
    ...
    HEADER wsCo "PAGE" AT 80 PAGE-NUMBER(a) SKIP(1) 
          "PAYMENT LISTING REPORT FOR THE PERIOD ENDED " wsDate SKIP(2)
 ...
 DEFINE FRAME frm-Paysys
     ...
     WITH 1 DOWN OVERLAY SIDE-LABELS CENTERED THREE-D 
      SIZE 95 BY 9
     TITLE "PAYMENT LISTING REPORT FROM HISTORY" VIEW-AS DIALOG-BOX.
...
FOR EACH payemf WHERE payemf.Paysys = wsSys AND payemf.Leaver = NO NO-LOCK BREAK BY payemf.Bank:
    wsAmt = 0.
    FOR EACH payhtf WHERE payhtf.empcode = Payemf.empcode AND payhtf.trDate = wsDate AND CurAmt <> 0 NO-LOCK:
        FIND FIRST payitem WHERE payitem.itemcode = payhtf.itemcode NO-LOCK NO-ERROR.
        IF payitem.cat = 3 THEN NEXT.
        ASSIGN wsAmt = wsAmt + payhtf.CurAmt WHEN payitem.cat = 1
               wsAmt = wsAmt - payhtf.CurAmt WHEN payitem.cat = 2.
    END.
