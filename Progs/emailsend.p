...
DEF VAR txtUnWanted AS CHAR EXTENT 5.
DEF VAR txtCont AS CHAR.
...
PROCEDURE report.ip:
    ...
    txtCont = "~{".
    txtCont =  txtCont + '"' + "control" + '"'.
    txtCont = txtCont + ":[~{".
    txtCont = txtCont + '"' + "conme" + '":' + '"' +  SIMCTR.CONAME + '",'.
    txtCont = txtCont + '"' + "Add1" + '":' + '"' +  SIMCTR.Add1 + '",'.
    txtCont = txtCont + '"' + "Add2" + '":' + '"' +  SIMCTR.Add2 + '",'.
    txtCont = txtCont + '"' + "Add3" + '":' + '"' +  SIMCTR.Add3 + '",'.
    txtCont = txtCont + '"' + "regno" + '":' + '"' +  SIMCTR.REGNO + '",'.
    txtCont = txtCont + '"' + "phone" + '":' + '"' +  SIMCTR.phone + '",'.
    txtCont = txtCont + '"' + "rMsg" + '":' + '"' +  wsMessage3:SCREEN-VALUE IN FRAME frm-main + '",'.
    txtCont = txtCont + '"' + "serveradd" + '":' + '"' +  SIMCTR1.serveradd + '",'.
    txtCont = txtCont + '"' + "serverport" + '":' + '"' +  string(SIMCTR1.serverport) + '",'.
    txtCont = txtCont + '"' + "serverpass" + '":' + '"' +  SIMCTR1.serverpass + '",'.
    txtCont = txtCont + '"' + "serveremail" + '":' + '"' +  SIMCTR1.serveremail + '",'.
    txtCont = txtCont + '"' + "bpno" + '":' + '"' +  SIMCTR.bpno + '",'.
    txtCont = txtCont + '"' + "rsemail" + '":' + '"' +  SIMCTR1.email + '"'.
    txtCont = txtCont + '}]}'.
   MESSAGE txtCont VIEW-AS ALERT-BOX.
    EXPORT STREAM a txtCont.
   END PROCEDURE.
