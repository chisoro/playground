...
/* Program.................exTRANTYPE.p
   Notes:................. Export Banks Readings
   Author:.................S. Chisoro
...
DEF FRAME frm-main
    SKIP(1)
   CN       COLON 26  LABEL "Processing Account........." VIEW-AS TEXT
    ...
    WITH 1 DOWN OVERLAY SIDE-LABELS CENTERED THREE-D 
     SIZE 85 BY 13.0
    TITLE "TRANSACTION TYPE EXPORT" VIEW-AS DIALOG-BOX.
   ...
   FOR EACH CBTYPE:
        cn = cn + 1.
            ASSIGN cn:SCREEN-VALUE IN FRAME frm-main = string(cn).
                    EXPORT DELIMITER "," TranType descrip DrCr.
     END.
