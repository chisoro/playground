...
define frame frm-input
    {&skey}                   colon 30 label "SubCategory"
...
ON CHOOSE OF btn-Del DO:
    ...
    FIND FIRST glmf WHERE glmf.subcat  = bfr{&tmptable}.subcat NO-ERROR.
...
PROCEDURE proc-edit:
    GET CURRENT qry-{&tmptable} EXCLUSIVE-LOCK NO-WAIT.
    ASSIGN wsid = DEC(bfr{&tmptable}.subcat).
    FIND FIRST bfr{&tmptable} WHERE bfr{&tmptable}.subcat  = wsid NO-ERROR.
